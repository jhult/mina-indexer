...
use crate::protocol::{
    ...
    serialization_types::{
        bulletproof_challenges::{
            BulletproofChallengeTuple18Json, BulletproofChallengeTuple18V1,
            BulletproofChallengesJson, BulletproofChallengesV1, BulletproofPreChallengeJson,
            BulletproofPreChallengeV1, ProofStateBulletproofChallengesJson,
            ProofStateBulletproofChallengesV1, ScalarChallengeVector2Json,
            ScalarChallengeVector2V1,
        },
        common::{BigInt256, CharJson, CharV1, Hex64V1, I64},
        field_and_curve_elements::{
            FieldElementJson, FiniteECPoint, FiniteECPointJson, FiniteECPointVecJson,
            FiniteECPointVecV1,
        },
...
impl Serialize for ProtocolStateProofBase64Json {
        ...
        S: Serializer,
    {
        ...
        let s = BASE64_URL_SAFE.encode(bytes);
