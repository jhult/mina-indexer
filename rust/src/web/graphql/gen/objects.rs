...
use super::{
    ...
    input_objects::{
        BlockInsertInput, BlockQueryInput, BlockUpdateInput, FeetransferInsertInput,
        FeetransferQueryInput, FeetransferUpdateInput, NextstakeInsertInput, NextstakeQueryInput,
        NextstakeUpdateInput, SnarkInsertInput, SnarkQueryInput, SnarkUpdateInput,
        StakeInsertInput, StakeQueryInput, StakeUpdateInput, TransactionInsertInput,
        TransactionQueryInput, TransactionUpdateInput,
    },
...
#[Object]
impl Mutation {
    pub async fn delete_many_blocks(
        &self,
        ctx: &Context<'_>,
        query: Option<BlockQueryInput>,
    ) -> Result<Option<DeleteManyPayload>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_delete_many_blocks(ctx, self, query)
            .await
    }
    pub async fn delete_many_feetransfers(
        &self,
        ctx: &Context<'_>,
        query: Option<FeetransferQueryInput>,
    ) -> Result<Option<DeleteManyPayload>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_delete_many_feetransfers(ctx, self, query)
            .await
    }
    pub async fn delete_many_nextstakes(
        &self,
        ctx: &Context<'_>,
        query: Option<NextstakeQueryInput>,
    ) -> Result<Option<DeleteManyPayload>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_delete_many_nextstakes(ctx, self, query)
            .await
    }
    pub async fn delete_many_snarks(
        &self,
        ctx: &Context<'_>,
        query: Option<SnarkQueryInput>,
    ) -> Result<Option<DeleteManyPayload>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_delete_many_snarks(ctx, self, query)
            .await
    }
    pub async fn delete_many_stakes(
        &self,
        ctx: &Context<'_>,
        query: Option<StakeQueryInput>,
    ) -> Result<Option<DeleteManyPayload>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_delete_many_stakes(ctx, self, query)
            .await
    }
    pub async fn delete_many_transactions(
        &self,
        ctx: &Context<'_>,
        query: Option<TransactionQueryInput>,
    ) -> Result<Option<DeleteManyPayload>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_delete_many_transactions(ctx, self, query)
            .await
    }
    pub async fn delete_one_block(
        &self,
        ctx: &Context<'_>,
        query: BlockQueryInput,
    ) -> Result<Option<Block>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_delete_one_block(ctx, self, query)
            .await
    }
    pub async fn delete_one_feetransfer(
        &self,
        ctx: &Context<'_>,
        query: FeetransferQueryInput,
    ) -> Result<Option<Feetransfer>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_delete_one_feetransfer(ctx, self, query)
            .await
    }
    pub async fn delete_one_nextstake(
        &self,
        ctx: &Context<'_>,
        query: NextstakeQueryInput,
    ) -> Result<Option<Nextstake>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_delete_one_nextstake(ctx, self, query)
            .await
    }
    pub async fn delete_one_snark(
        &self,
        ctx: &Context<'_>,
        query: SnarkQueryInput,
    ) -> Result<Option<Snark>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_delete_one_snark(ctx, self, query)
            .await
    }
    pub async fn delete_one_stake(
        &self,
        ctx: &Context<'_>,
        query: StakeQueryInput,
    ) -> Result<Option<Stake>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_delete_one_stake(ctx, self, query)
            .await
    }
    pub async fn delete_one_transaction(
        &self,
        ctx: &Context<'_>,
        query: TransactionQueryInput,
    ) -> Result<Option<Transaction>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_delete_one_transaction(ctx, self, query)
            .await
    }
    pub async fn insert_many_blocks(
        &self,
        ctx: &Context<'_>,
        data: Vec<BlockInsertInput>,
    ) -> Result<Option<InsertManyPayload>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_insert_many_blocks(ctx, self, data)
            .await
    }
    pub async fn insert_many_feetransfers(
        &self,
        ctx: &Context<'_>,
        data: Vec<FeetransferInsertInput>,
    ) -> Result<Option<InsertManyPayload>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_insert_many_feetransfers(ctx, self, data)
            .await
    }
    pub async fn insert_many_nextstakes(
        &self,
        ctx: &Context<'_>,
        data: Vec<NextstakeInsertInput>,
    ) -> Result<Option<InsertManyPayload>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_insert_many_nextstakes(ctx, self, data)
            .await
    }
    pub async fn insert_many_snarks(
        &self,
        ctx: &Context<'_>,
        data: Vec<SnarkInsertInput>,
    ) -> Result<Option<InsertManyPayload>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_insert_many_snarks(ctx, self, data)
            .await
    }
    pub async fn insert_many_stakes(
        &self,
        ctx: &Context<'_>,
        data: Vec<StakeInsertInput>,
    ) -> Result<Option<InsertManyPayload>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_insert_many_stakes(ctx, self, data)
            .await
    }
    pub async fn insert_many_transactions(
        &self,
        ctx: &Context<'_>,
        data: Vec<TransactionInsertInput>,
    ) -> Result<Option<InsertManyPayload>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_insert_many_transactions(ctx, self, data)
            .await
    }
    pub async fn insert_one_block(
        &self,
        ctx: &Context<'_>,
        data: BlockInsertInput,
    ) -> Result<Option<Block>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_insert_one_block(ctx, self, data)
            .await
    }
    pub async fn insert_one_feetransfer(
        &self,
        ctx: &Context<'_>,
        data: FeetransferInsertInput,
    ) -> Result<Option<Feetransfer>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_insert_one_feetransfer(ctx, self, data)
            .await
    }
    pub async fn insert_one_nextstake(
        &self,
        ctx: &Context<'_>,
        data: NextstakeInsertInput,
    ) -> Result<Option<Nextstake>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_insert_one_nextstake(ctx, self, data)
            .await
    }
    pub async fn insert_one_snark(
        &self,
        ctx: &Context<'_>,
        data: SnarkInsertInput,
    ) -> Result<Option<Snark>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_insert_one_snark(ctx, self, data)
            .await
    }
    pub async fn insert_one_stake(
        &self,
        ctx: &Context<'_>,
        data: StakeInsertInput,
    ) -> Result<Option<Stake>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_insert_one_stake(ctx, self, data)
            .await
    }
    pub async fn insert_one_transaction(
        &self,
        ctx: &Context<'_>,
        data: TransactionInsertInput,
    ) -> Result<Option<Transaction>> {
        ctx.data_unchecked::<DataSource>()
            .mutation_insert_one_transaction(ctx, self, data)
            .await
    }
    pub async fn replace_one_block(
        &self,
        ctx: &Context<'_>,
        query: Option<BlockQueryInput>,
        data: BlockInsertInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_replace_one_block(ctx, self, query, data)
            .await
    }
    pub async fn replace_one_feetransfer(
        &self,
        ctx: &Context<'_>,
        query: Option<FeetransferQueryInput>,
        data: FeetransferInsertInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_replace_one_feetransfer(ctx, self, query, data)
            .await
    }
    pub async fn replace_one_nextstake(
        &self,
        ctx: &Context<'_>,
        query: Option<NextstakeQueryInput>,
        data: NextstakeInsertInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_replace_one_nextstake(ctx, self, query, data)
            .await
    }
    pub async fn replace_one_snark(
        &self,
        ctx: &Context<'_>,
        query: Option<SnarkQueryInput>,
        data: SnarkInsertInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_replace_one_snark(ctx, self, query, data)
            .await
    }
    pub async fn replace_one_stake(
        &self,
        ctx: &Context<'_>,
        query: Option<StakeQueryInput>,
        data: StakeInsertInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_replace_one_stake(ctx, self, query, data)
            .await
    }
    pub async fn replace_one_transaction(
        &self,
        ctx: &Context<'_>,
        query: Option<TransactionQueryInput>,
        data: TransactionInsertInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_replace_one_transaction(ctx, self, query, data)
            .await
    }
    pub async fn update_many_blocks(
        &self,
        ctx: &Context<'_>,
        query: Option<BlockQueryInput>,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_update_many_blocks(ctx, self, query, set)
            .await
    }
    pub async fn update_many_feetransfers(
        &self,
        ctx: &Context<'_>,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_update_many_feetransfers(ctx, self, set, query)
            .await
    }
    pub async fn update_many_nextstakes(
        &self,
        ctx: &Context<'_>,
        query: Option<NextstakeQueryInput>,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_update_many_nextstakes(ctx, self, query, set)
            .await
    }
    pub async fn update_many_snarks(
        &self,
        ctx: &Context<'_>,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_update_many_snarks(ctx, self, set, query)
            .await
    }
    pub async fn update_many_stakes(
        &self,
        ctx: &Context<'_>,
        query: Option<StakeQueryInput>,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_update_many_stakes(ctx, self, query, set)
            .await
    }
    pub async fn update_many_transactions(
        &self,
        ctx: &Context<'_>,
        query: Option<TransactionQueryInput>,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_update_many_transactions(ctx, self, query, set)
            .await
    }
    pub async fn update_one_block(
        &self,
        ctx: &Context<'_>,
        query: Option<BlockQueryInput>,
        set: BlockUpdateInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_update_one_block(ctx, self, query, set)
            .await
    }
    pub async fn update_one_feetransfer(
        &self,
        ctx: &Context<'_>,
        set: FeetransferUpdateInput,
        query: Option<FeetransferQueryInput>,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_update_one_feetransfer(ctx, self, set, query)
            .await
    }
    pub async fn update_one_nextstake(
        &self,
        ctx: &Context<'_>,
        query: Option<NextstakeQueryInput>,
        set: NextstakeUpdateInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_update_one_nextstake(ctx, self, query, set)
            .await
    }
    pub async fn update_one_snark(
        &self,
        ctx: &Context<'_>,
        query: Option<SnarkQueryInput>,
        set: SnarkUpdateInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_update_one_snark(ctx, self, query, set)
            .await
    }
    pub async fn update_one_stake(
        &self,
        ctx: &Context<'_>,
        query: Option<StakeQueryInput>,
        set: StakeUpdateInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_update_one_stake(ctx, self, query, set)
            .await
    }
    pub async fn update_one_transaction(
        &self,
        ctx: &Context<'_>,
        query: Option<TransactionQueryInput>,
        set: TransactionUpdateInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_update_one_transaction(ctx, self, query, set)
            .await
    }
    pub async fn upsert_one_block(
        &self,
        ctx: &Context<'_>,
        query: Option<BlockQueryInput>,
        data: BlockInsertInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_upsert_one_block(ctx, self, query, data)
            .await
    }
    pub async fn upsert_one_feetransfer(
        &self,
        ctx: &Context<'_>,
        query: Option<FeetransferQueryInput>,
        data: FeetransferInsertInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_upsert_one_feetransfer(ctx, self, query, data)
            .await
    }
    pub async fn upsert_one_nextstake(
        &self,
        ctx: &Context<'_>,
        data: NextstakeInsertInput,
        query: Option<NextstakeQueryInput>,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_upsert_one_nextstake(ctx, self, data, query)
            .await
    }
    pub async fn upsert_one_snark(
        &self,
        ctx: &Context<'_>,
        query: Option<SnarkQueryInput>,
        data: SnarkInsertInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_upsert_one_snark(ctx, self, query, data)
            .await
    }
    pub async fn upsert_one_stake(
        &self,
        ctx: &Context<'_>,
        query: Option<StakeQueryInput>,
        data: StakeInsertInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_upsert_one_stake(ctx, self, query, data)
            .await
    }
    pub async fn upsert_one_transaction(
        &self,
        ctx: &Context<'_>,
        query: Option<TransactionQueryInput>,
        data: TransactionInsertInput,
        ...
        ctx.data_unchecked::<DataSource>()
            .mutation_upsert_one_transaction(ctx, self, query, data)
            .await
    }
}
