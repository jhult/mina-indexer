...
use crate::web::graphql::DataSource;
use async_graphql::*;
#[derive(Debug, Clone)]
...
pub struct BlockTransaction {
    pub coinbase: String,
    pub coinbase_receiver_account: BlockTransactionCoinbaseReceiverAccount,
    pub fee_transfer: Vec<Option<BlockTransactionFeeTransfer>>,
    pub user_commands: Vec<Option<BlockTransactionUserCommand>>,
}
#[Object]
impl BlockTransaction {
    ...
    pub async fn coinbase_receiver_account(&self) -> BlockTransactionCoinbaseReceiverAccount {
        self.coinbase_receiver_account.clone()
    }
    pub async fn fee_transfer(&self) -> Vec<Option<BlockTransactionFeeTransfer>> {
        self.fee_transfer.clone()
    }
    pub async fn user_commands(&self) -> Vec<Option<BlockTransactionUserCommand>> {
...
pub struct BlockTransactionUserCommand {
    ...
    pub fee: f64,
    pub fee_payer: Option<BlockTransactionUserCommandFeePayer>,
    pub fee_token: Option<i64>,
    pub from: String,
    pub from_account: Option<BlockTransactionUserCommandFromAccount>,
    pub hash: String,
    pub id: String,
    ...
    pub receiver: Option<BlockTransactionUserCommandReceiver>,
    pub source: Option<BlockTransactionUserCommandSource>,
    pub to: String,
    pub to_account: Option<BlockTransactionUserCommandToAccount>,
    pub token: Option<i64>,
}
#[Object]
impl BlockTransactionUserCommand {
    ...
    pub async fn receiver(&self) -> Option<BlockTransactionUserCommandReceiver> {
        self.receiver.clone()
    }
...
pub struct BlockWinnerAccount {
    pub balance: BlockWinnerAccountBalance,
    pub public_key: String,
}
#[Object]
...
pub struct Stake {
    ...
    pub chain_id: String,
    pub delegate: String,
    pub delegation_totals: DelegationTotal,
    pub epoch: i64,
    pub ledger_hash: String,
    pub nonce: i64,
    pub permissions: Option<StakePermission>,
    pub pk: Option<String>,
    pub public_key: String,
    pub receipt_chain_hash: String,
    pub timing: Option<StakeTiming>,
    pub token: i64,
...
pub struct Nextstake {
    ...
    pub delegate: String,
    pub ledger_hash: String,
    pub next_delegation_totals: NextDelegationTotal,
    pub nonce: i64,
    pub permissions: Option<NextstakePermission>,
    pub pk: String,
    pub public_key: String,
    pub receipt_chain_hash: String,
    pub timing: Option<NextstakeTiming>,
    pub token: i64,
    pub voting_for: String,
}
#[Object]
...
impl Feetransfer {
    ...
    pub async fn block_state_hash(&self) -> Option<Block> {
        self.block_state_hash.clone()
    }
