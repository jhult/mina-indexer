...
deploy-local-prod blocks='5000' web_port='' exclude_non_canonical='n': nix-build
...
deploy-local-prod-dev blocks='5000' web_port='' exclude_non_canonical='y': debug-build
